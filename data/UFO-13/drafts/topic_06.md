...
316. A cordial greeting and thanking the Commission and my thanks for inviting me to present this information.
...
320. You can see that here, this document was a 1982 document that was produced by the U.S.
...
323. It was ineffective to try to destroy this UFO.
→ {"text": "試圖摧毀這架不明飛行物的行動並未奏效。", "confidence": "high", "notes": ""}

324. Second page, there's more details about this event given the name of the base and other details pertaining.
→ {"text": "第二頁有更多關於此事件的細節，包括基地名稱及其他相關資訊。", "confidence": "high", "notes": ""}

325. The pilot that was driving, I was the pilot that was piloting this airplane, and I will be very happy to narrate and explain the events that occurred.
→ {"text": "當時駕駛這架飛機的飛行員就是我本人，我很榮幸能為各位敘述並說明當時發生的事件。", "confidence": "high", "notes": ""}

326. I was the pilot in this airplane trying to intercept the UFO.
...
329. This was a strange location that was not allowed except for military, so we thought it was a espionage for this military base, and it could be considered a danger for the security of the country.
→ {"text": "該區域屬於軍事管制區，一般民眾不得進入，因此我們認為這可能是針對該軍事基地的間諜活動，可能對國家安全構成威脅。", "confidence": "high", "notes": ""}

330. So the squad was ordered that one of the pilots did have to go up in the air and follow the object and destroy the object.
→ {"text": "因此中隊接到命令，必須派遣一名飛行員升空追蹤並摧毀該物體。", "confidence": "high", "notes": ""}

331. The air command gave me the order to take off and to shoot this object before it approaches too fast to the base.
→ {"text": "空軍指揮部命令我立即起飛，在該物體過於接近基地之前將其擊落。", "confidence": "high", "notes": ""}

332. So I first approached this object, and this airplane that I was piloting had military weapons.
...
335. During the persecution of this globe, I had a 900 kilometers per hour speed, but I couldn't reach him.
→ {"text": "在追擊這個氣球形飛行器期間，我的速度達到每小時 900 公里，但仍無法追上它。", "confidence": "high", "notes": ""}

336. When I arrived to 84 kilometers of distance from the base, this globe stopped very quickly.
→ {"text": "當我飛至距離基地 84 公里處時，這個氣球形飛行器突然停止。", "confidence": "high", "notes": ""}

337. I had to make a very quick maneuver to avoid confrontation.
→ {"text": "我必須做出一個非常快速的機動動作以避免相撞。", "confidence": "high", "notes": ""}

338. When I wasn't getting close to shooting again at the distance, the object did a very fast movement and went underneath my airplane without allowing me to shoot.
→ {"text": "當我準備再次接近並開火時，該物體做出一個極快的動作，從我的飛機下方穿過，讓我無法射擊。", "confidence": "high", "notes": ""}

339. Our locations evaded my location and avoided on the last minute all my intent to shoot.
→ {"text": "該物體迴避了我的位置，並在最後一刻躲過了我所有的射擊企圖。", "confidence": "high", "notes": ""}

340. Confronted with this situation, I took the decision to speed on a very high velocity and ascend very high to go ahead and attack in a very vertical manner, but the globe did have a maneuver of lifting very, very quickly, so I wasn't able to focus to shoot.
...
343. With the UFO parallel to my plane, I kept going up, hoping to be able to surpass it to be able to get into attack position, but I was unable to do so.
...
→ {"text": "它沒有任何機翼、噴射推進器、窗戶、天線或類似的東西。", "confidence": "high", "notes": ""}

349. These are obviously surfaces that aircraft usually have; pulling myself together, I went back to the air base, and I reported to the control tower what I had seen.
→ {"text": "這些顯然是一般飛機通常會有的構造；我穩定心神後，返回空軍基地，並向塔台報告我所看到的一切。", "confidence": "high", "notes": ""}

350. In total, there were 22 minutes of maneuvers that are clearly etched in my brain, and I am convinced that there is extraterrestrial technology and life.
→ {"text": "總共 22 分鐘的機動動作深深烙印在我的腦海中，我確信外星技術與外星生命的存在。", "confidence": "high", "notes": ""}

351. I will never forget what I saw that day, and this is a sketch of what I saw.
→ {"text": "我永遠不會忘記那天所見，這是我所看到的素描圖。", "confidence": "high", "notes": ""}

352. If you could go on to the next slide.
→ {"text": "請看下一張投影片。", "confidence": "high", "notes": ""}

353. It more or less looked like this, and the two next slides we can see.
→ {"text": "它大致上看起來就是這樣，接下來兩張投影片我們可以看到。", "confidence": "high", "notes": ""}

354. This is a photo of me with my plane.
→ {"text": "這是我與我的飛機的合照。", "confidence": "high", "notes": ""}

355. This is from 1980.
→ {"text": "這是 1980 年拍攝的。", "confidence": "high", "notes": ""}

356. Next slide, please.
→ {"text": "請看下一張投影片。", "confidence": "high", "notes": ""}
...
359. That is the end of my remarks.
→ {"text": "我的報告到此結束。", "confidence": "high", "notes": ""}

360. That must have been some ride.
→ {"text": "那一定是一次驚心動魄的飛行經歷。", "confidence": "high", "notes": "委員會成員的回應，語帶雙關"}

...
206. Thank you for inviting me here.
...
209. In other words, some, underlined 10 times, some UFOs are alien spacecraft.
→ {"text": "換句話說，某些——強調 10 次——某些不明飛行物是外星太空船。", "confidence": "high", "notes": ""}

210. Most are not.
→ {"text": "大多數都不是。", "confidence": "high", "notes": ""}

211. Don't care about them.
→ {"text": "不在乎那些。", "confidence": "high", "notes": ""}

212. Two, there is no doubt that a small number of people within governments, both in the United States and overseas, have been actively covering up the truth about these visits.
...
217. Very few UFOs are flying saucers.
→ {"text": "極少數的不明飛行物是飛碟。", "confidence": "high", "notes": ""}

218. All great-grandfathers are men, not all men are great-grandfathers.
→ {"text": "所有曾祖父都是男人，但並非所有男人都是曾祖父。", "confidence": "high", "notes": ""}

219. I'm interested in the flying saucers, not the UFOs.
→ {"text": "我感興趣的是飛碟，而不是不明飛行物。", "confidence": "high", "notes": ""}

220. The basis for these conclusions, A, there are at least five large-scale scientific studies which provide substantial evidence.
...
230. Even the unknown 3% could have been identified as conventional phenomena or illusions if more complete observational data had been available."
→ {"text": "即使是那未知的 3%，如果有更完整的觀測數據，也可以被識別為傳統現象或錯覺。」", "confidence": "high", "notes": ""}

231. The fact of the matter in the report that he was talking about is that the unknowns comprise 21.5% of the cases completely separate from the 9.3% listed as insufficient information.
→ {"text": "事實上，他所談論的報告中，未知案例佔了 21.5%，完全獨立於被列為資訊不足的 9.3%。", "confidence": "high", "notes": ""}

232. The 3% number was a lie.
→ {"text": "3% 這個數字是謊言。", "confidence": "high", "notes": ""}

233. Furthermore, a statistical comparison of the unknowns and knowns showed that the probability that the unknowns were just misknowns was less than 1%.
...
236. They'd never heard about them.
→ {"text": "他們從未聽說過那些報告。", "confidence": "high", "notes": ""}

237. The correct answer, had it been given, would have been that they were all classified.
→ {"text": "正確答案——如果他們給出的話——應該是那些報告全都被列為機密。", "confidence": "high", "notes": ""}

238. It's a very valuable source of information, this report.
→ {"text": "這份報告是非常寶貴的資訊來源。", "confidence": "high", "notes": ""}

239. It's funny how the debunkers never talk about it.
→ {"text": "有趣的是，揭穿者從不談論這份報告。", "confidence": "high", "notes": ""}

240. Another primary source of valuable data, which should be of interest to you all, are the congressional hearings of July 29, 1968, which included testimony from 12 scientists.
...
245. Saucer is seen on the ground, it leaves, they find physical changes, happens here, it happens there, it happens everywhere.
→ {"text": "飛碟被目擊降落在地面，它離開後，他們發現物理變化——這裡發生、那裡發生、到處都發生。", "confidence": "high", "notes": ""}

246. One-sixth of those cases involved reports of small beings associated with the craft while it was on the ground.
...
249. The proceedings, incidentally, are still available online.
...
254. There's a two-volume report called the UFO Evidence, which has loads of data, hundreds of cases that couldn't be identified.
...
257. One of them demonstrating how poor the press coverage has been.
→ {"text": "其中一篇論文展示了新聞報導有多麼糟糕。", "confidence": "high", "notes": ""}

258. I haven't seen one about coverage by the scientific community or coverage by the political committee.
→ {"text": "我還沒看到關於科學界報導或政治委員會報導的論文。", "confidence": "high", "notes": ""}

259. That's another story.
→ {"text": "那是另一回事。", "confidence": "high", "notes": ""}

260. Anybody need a PhD thesis topic?
→ {"text": "有人需要博士論文主題嗎？", "confidence": "high", "notes": ""}

261. There's two good ones.
→ {"text": "這裡有兩個很好的主題。", "confidence": "high", "notes": ""}

262. Also a third one, the will not to believe on the part of scientists.
→ {"text": "還有第三個，關於科學家刻意不願相信的意志。", "confidence": "high", "notes": ""}

263. It's a sickness, a disease, if you will, infecting people who think they know all there is to know and don't.
...
266. The title of the article, believe it or not, is The Science Behind UFOs, it's a cover story.
...
269. To give you a form of reference, every star in the universe or multiverse produces its energy by nuclear fusion.
→ {"text": "給你們一個參考框架，宇宙或多元宇宙中的每一顆恆星都是透過核融合產生能量。", "confidence": "high", "notes": ""}

270. That's what H-bombs are all about.
→ {"text": "這就是氫彈的原理。", "confidence": "high", "notes": ""}

271. And a good demonstration of the atom and the UFO together, if you will, is that in a very short period we managed to go from a 10-ton blockbuster, World War II, 1945, took a big B-29 to carry it.
...
278. I'm not saying it's the ultimate technology.
→ {"text": "我並不是說這是終極技術。", "confidence": "high", "notes": ""}

279. I'm saying scientific progress comes from doing things differently in an unpredictable way.
→ {"text": "我是說，科學進步來自於以不可預測的方式做不同的事情。", "confidence": "high", "notes": ""}

280. The future is not an extrapolation of the past.
→ {"text": "未來不是過去的外推。", "confidence": "high", "notes": ""}

281. You have to change how you do things.
→ {"text": "你必須改變做事的方式。", "confidence": "high", "notes": ""}

282. And what gets to me, having worked on fusion propulsion, fission propulsion, nuclear reactors for space applications, and all the rest of this, is that we tend to forget that if you make enough stupid assumptions, you can prove almost anything is impossible.
→ {"text": "令我困擾的是，在從事過核融合推進、核分裂推進、太空應用的核反應爐以及所有這些工作之後，我們往往忘記，如果你做出足夠多愚蠢的假設，你就可以證明幾乎任何事情都是不可能的。", "confidence": "high", "notes": ""}

283. One quick example, one astronomer in 1941.
→ {"text": "舉一個簡單的例子，1941 年有一位天文學家。", "confidence": "high", "notes": ""}

284. He was fed up with all the science fiction stuff about going to the moon.
→ {"text": "他厭倦了所有關於登月的科幻小說內容。", "confidence": "high", "notes": ""}

285. That was nonsense, he said.
→ {"text": "他說，那是胡說八道。", "confidence": "high", "notes": ""}

286. So he published a scientific, in quotes, paper calculating the required initial launch weight of a rocket able to get a man to the moon and back.
→ {"text": "於是他發表了一篇「科學」論文，計算能夠將人送上月球並返回所需的初始發射重量。", "confidence": "high", "notes": ""}

287. Legitimate question, how big is it got to be?
→ {"text": "這是一個合理的問題：它必須有多大？", "confidence": "high", "notes": ""}

288. Pages of equations, he concluded it would have to weigh a million, million tons.
→ {"text": "經過數頁的方程式計算，他得出結論：它必須重達一百萬個百萬噸。", "confidence": "high", "notes": ""}

289. It was off by a factor of 300 million.
→ {"text": "他的計算偏差了 3 億倍。", "confidence": "high", "notes": ""}

290. Proving if you make enough stupid assumptions, you can prove anything is impossible.
→ {"text": "這證明了，如果你做出足夠多愚蠢的假設，你就可以證明任何事情都是不可能的。", "confidence": "high", "notes": ""}

291. So we have reason to be very careful when somebody says something is impossible.
...
296. The space station goes around the world in 90 minutes.
→ {"text": "太空站在 90 分鐘內就能繞地球一圈。", "confidence": "high", "notes": ""}

297. Progress comes from doing things differently.
...
300. Another one of the false myths is that governments can't keep secrets.
...
303. He didn't mention the CIA, the DIA, the NRO, the NSA and all those other alphabet soup agencies.
...
309. Everything else is whited out, not blacked out, they said that was too impressive on television when I used that, they told me this.
→ {"text": "其他所有內容都被塗白了，而不是塗黑——他們告訴我，當我在電視上使用那些文件時，塗黑看起來太引人注目了。", "confidence": "high", "notes": ""}

310. And the reason is everything else is sources and methods.
→ {"text": "原因是其他所有內容都是情報來源與方法。", "confidence": "high", "notes": ""}

311. Twenty-eight percent sources and methods and two percent UFOs but it's filed under UFOs.
→ {"text": "28% 是情報來源與方法，2% 是 UFO，但它被歸檔在 UFO 類別下。", "confidence": "high", "notes": ""}

312. Come on, that makes no sense.
→ {"text": "拜託，這說不通。", "confidence": "high", "notes": ""}

313. You can get a bunch of CIA, and I'll show some of these too, blacked out UFO documents.
→ {"text": "你可以取得一堆 CIA 的被塗黑的 UFO 文件——我也會展示其中一些。", "confidence": "high", "notes": ""}

314. So highly redacted that you can read about six words per page.
→ {"text": "被大量刪減，每頁只能讀到大約六個字。", "confidence": "high", "notes": ""}

315. And my favorite thing, and it took me three years to get this, was one of the CIA UFO documents that says on the top, "Deny in Toto."
→ {"text": "而我最喜歡的是——我花了三年時間才取得這份文件——一份 CIA UFO 文件，頂部寫著「全面否認」(Deny in Toto)。", "confidence": "high", "notes": ""}

316. They couldn't find six lousy words to declassify.
→ {"text": "他們連六個可憐的字都找不出來解密。", "confidence": "high", "notes": ""}

317. Something's wrong here.
→ {"text": "這裡有問題。", "confidence": "high", "notes": ""}

318. I have to tell you, one minute, okay, I won't tell you, maybe I'll tell you that Tuesday night.
...
323. I located him, I talked to him on the phone, he verified there are two separate reporting channels.
→ {"text": "我找到了他，我和他通過電話，他證實存在兩個獨立的報告管道。", "confidence": "high", "notes": ""}

324. He never heard that from the Air Force.
...
328. Just one more sentence here, two sentences.
→ {"text": "這裡再說一句話，兩句話。", "confidence": "high", "notes": ""}

329. I've won several debates on UFOs.
→ {"text": "我贏得了多場關於 UFO 的辯論。", "confidence": "high", "notes": ""}

330. I've only had 11 hecklers and over 700 lectures.
→ {"text": "在超過 700 場演講中，我只遇到過 11 個起鬨者。", "confidence": "high", "notes": ""}

331. It's past time for the press, scientific and political communities to do their homework.
→ {"text": "新聞界、科學界與政治界早就應該做好他們的功課了。", "confidence": "high", "notes": ""}

332. And I should add at least three UFO crashes have occurred.
→ {"text": "而且我應該補充，至少發生過三起 UFO 墜毀事件。", "confidence": "high", "notes": ""}

333. You'll hear more about those later in these hearings.
→ {"text": "你們稍後會在這些聽證會中聽到更多相關資訊。", "confidence": "high", "notes": ""}

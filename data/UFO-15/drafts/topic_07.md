...
358. And then when we come back after break, you'll have another chance to go through.
...
363. That's correct, sir, yes.
→ {"text": "是的，先生，沒錯。", "confidence": "high", "notes": ""}

364. You are currently not working for the Ministry of Defense.
→ {"text": "你目前已經不在國防部工作了。", "confidence": "high", "notes": ""}

365. Am I correct on that?
...
369. Since you left-- well, while you were there.
→ {"text": "從你離職後——嗯，其實在職期間也是。", "confidence": "high", "notes": ""}

370. And certainly, you've been involved since you left.
→ {"text": "當然，離職後你一直有在參與。", "confidence": "high", "notes": ""}

371. Yes, sir, in a private capacity.
→ {"text": "是的，先生，是以私人身份。", "confidence": "high", "notes": ""}

372. In a private capacity, I understand, at this time.
...
377. If you'll excuse the pun, I think we were even worse resourced than Project Blue Book.
→ {"text": "恕我開個玩笑，我認為我們的資源甚至比藍皮書計畫還要少。", "confidence": "high", "notes": ""}
...
382. So they're open files.
→ {"text": "所以這些是公開檔案。", "confidence": "high", "notes": ""}

383. They are-- Or are-- well, let's explain.
→ {"text": "它們是——或者說——嗯，讓我們解釋一下。", "confidence": "high", "notes": ""}

384. Tell me-- I don't want to put words in your mouth.
→ {"text": "告訴我——我不想替你說話。", "confidence": "high", "notes": ""}

385. What are those files?
→ {"text": "那些檔案是什麼狀態？", "confidence": "high", "notes": ""}

386. Are they open, closed, kind of high clearance to get it to-- go ahead.
→ {"text": "是公開的、封閉的，還是需要高層級許可才能取得——請說。", "confidence": "high", "notes": ""}

387. The material is at the UK National Archives website.
→ {"text": "這些資料都在英國國家檔案館的網站上。", "confidence": "high", "notes": ""}

388. And I'm afraid to say there is a small charge for access.
→ {"text": "恐怕要說的是，查閱需要支付少量費用。", "confidence": "high", "notes": ""}

389. But-- Having said that, if you're prepared to pay that small charge, they're all open.
→ {"text": "但是——話雖如此，如果你願意支付那筆小額費用，它們都是公開的。", "confidence": "high", "notes": ""}

390. But many of the investigators here that have been witnesses would have no problem with that small charge, I'm sure.
→ {"text": "但我相信，這裡許多擔任過證人的調查員都不會介意那筆小額費用。", "confidence": "high", "notes": ""}

391. Yes, sir.
→ {"text": "是的，先生。", "confidence": "high", "notes": ""}

392. So I can imagine you, being as interested as you are, have looked at a lot of these documents.
→ {"text": "所以我可以想像，像你這樣感興趣的人，一定已經查閱了很多這些文件。", "confidence": "high", "notes": ""}

393. Or maybe you've even read every one of them.
→ {"text": "或者也許你甚至讀過了每一份文件。", "confidence": "high", "notes": ""}

394. I don't know.
→ {"text": "我不知道。", "confidence": "high", "notes": ""}

395. Would you explain to what extent you've analyzed these?
→ {"text": "能否說明一下你分析這些文件的程度？", "confidence": "high", "notes": ""}

396. When I did that job, I made it my business to research back into the archive and look at the historical documents.
→ {"text": "當我做那份工作時，我特意深入研究檔案並查閱歷史文件。", "confidence": "high", "notes": ""}

397. So I went right back to the inception.
...
403. I think it's more-- You said low probability but high consequence.
→ {"text": "我想應該是——你說的是機率低但後果嚴重。", "confidence": "high", "notes": ""}

404. Certainly nobody would question high consequence.
...
407. I think it was more a case, sir, that we couldn't rule that possibility out.
→ {"text": "先生，我認為更多的是我們無法排除那種可能性。", "confidence": "high", "notes": ""}

408. We said it was a sort of non-zero possibility.
→ {"text": "我們說這是一種非零的可能性。", "confidence": "high", "notes": ""}

409. But now I'm particularly interested, not in the official ministry position.
→ {"text": "但現在我特別感興趣的不是國防部的官方立場。", "confidence": "high", "notes": ""}

410. Because I know how politics works.
→ {"text": "因為我了解政治運作的方式。", "confidence": "high", "notes": ""}

411. And as you say, these are your words, sir.
→ {"text": "正如你所說，這是你的話，先生。", "confidence": "high", "notes": ""}

412. The UK acts like a lap dog to the United States.
→ {"text": "英國就像美國的跟班。", "confidence": "high", "notes": ""}

413. OK, so here's what I'm going to ask you.
→ {"text": "好的，所以我要問你的是。", "confidence": "high", "notes": ""}

414. What's your opinion after all the research you've done?
→ {"text": "在你做了所有研究之後，你的看法是什麼？", "confidence": "high", "notes": ""}

415. And based on all that stuff that you've had access to, is there an ET origin to what's obviously been accurate-- or I should say sightings of real UFOs?
→ {"text": "根據你所接觸到的所有資料，那些顯然是真實的——或者說真實 UFO 的目擊事件，是否有外星起源？", "confidence": "high", "notes": ""}

416. Now having sighted-- we're just repeating the concept that having sighted a UFO is not the same thing as saying there's an extraterrestrial component.
→ {"text": "現在我們重申這個概念——目擊 UFO 並不等於說有外星成分。", "confidence": "high", "notes": ""}

417. I want to know your opinion of that based on all that stuff that you have investigated.
→ {"text": "我想知道根據你所調查的所有資料，你對此的看法。", "confidence": "high", "notes": ""}

418. I think, sir, I would say that the evidence doesn't go quite far enough for me to say personally that I am absolutely sure we're being visited.
→ {"text": "先生，我想我會說證據還不足以讓我個人確信我們正受到造訪。", "confidence": "high", "notes": ""}

419. But I certainly think it is compelling enough that it is a possibility.
...
422. Fair enough.
→ {"text": "說得有理。", "confidence": "high", "notes": ""}

423. I've got just a minute left.
...
428. And it's documented that they talked about it at the time, not a lot later.
...
437. I know the time's expired.
→ {"text": "我知道時間到了。", "confidence": "high", "notes": ""}

438. I'll probably pick up with that on next round.
→ {"text": "下一輪我可能會繼續追問這個問題。", "confidence": "high", "notes": ""}
...
446. Do you interact with them?
→ {"text": "你們有與他們互動嗎？", "confidence": "high", "notes": ""}

447. Do they have their own beliefs about what this phenomenon is?
→ {"text": "他們對這個現象有自己的看法嗎？", "confidence": "high", "notes": ""}
...
454. I've got five minutes.
→ {"text": "我有五分鐘。", "confidence": "high", "notes": ""}

455. You've got 1 and 1/2 minutes.
→ {"text": "你只剩一分半鐘。", "confidence": "high", "notes": ""}

456. Let me ask, my question, my only question right now.
→ {"text": "讓我問我的問題，我現在唯一的一個問題。", "confidence": "high", "notes": ""}

457. We're going to come back.
...
460. No, I just want to ask the question.
→ {"text": "不，我只是想問這個問題。", "confidence": "high", "notes": ""}

461. I'm not trying to be rude.
→ {"text": "我不是故意無禮。", "confidence": "high", "notes": ""}

462. Help me out, Madam Chair, because I want to get all of them on one question.
...
466. This is exactly what the official Vatican paper wrote.
...
469. I appreciate that.
→ {"text": "我很感謝。", "confidence": "high", "notes": ""}

470. I'm still not sure if it's one or two thoughts, but I agree with what you said.
→ {"text": "我還是不確定這是一個還是兩個想法，但我同意你說的。", "confidence": "high", "notes": ""}

471. Thank you very much.
→ {"text": "非常感謝。", "confidence": "high", "notes": ""}

472. For all of you and all of your experiences, and I appreciate all your testimony.
...
475. Do you interact with the United States on this, and do they have some of the materials that you have collected over the years?
...
478. If you don't know, it's OK.
→ {"text": "如果你不知道，沒關係。", "confidence": "high", "notes": ""}

479. You can say that, too.
→ {"text": "你也可以這樣說。", "confidence": "high", "notes": ""}

480. So I wouldn't know.
→ {"text": "所以我不知道。", "confidence": "high", "notes": ""}

481. I would imagine that the Russians and the Americans have some dialogue on this, but that's an assumption.
...
484. And friends with friends, cousins, actually.
→ {"text": "而且朋友歸朋友，其實算是表親。", "confidence": "high", "notes": ""}

485. Yeah, I know we're allies, but-- Right, allies is a word.
→ {"text": "是的，我知道我們是盟友，但是——對，盟友只是一個詞。", "confidence": "high", "notes": ""}

486. Allies, but they're a little independent.
→ {"text": "盟友，但他們有點獨立。", "confidence": "high", "notes": ""}

487. So I don't think they would-- OK, and I don't want anybody to speculate.
→ {"text": "所以我不認為他們會——好的，而且我不希望任何人猜測。", "confidence": "high", "notes": ""}

488. It's OK to say if you don't know, you don't know.
→ {"text": "如果你不知道，說不知道是可以的。", "confidence": "high", "notes": ""}

489. No, I don't know.
→ {"text": "不，我不知道。", "confidence": "high", "notes": ""}

490. OK, but that's good enough.
→ {"text": "好的，但這樣就夠了。", "confidence": "high", "notes": ""}

491. And you're right about the relationships to our countries.
→ {"text": "你說的關於我們國家之間的關係是對的。", "confidence": "high", "notes": ""}

492. You're absolutely right.
→ {"text": "你完全正確。", "confidence": "high", "notes": ""}
...
497. Our terms of reference limited our investigations to the UK's air defense region.
→ {"text": "我們的職權範圍將調查限制在英國的防空區域內。", "confidence": "high", "notes": ""}

498. But we did, from time to time, through the embassies and open source, IE media, get reports from other countries.
→ {"text": "但我們確實時不時地透過大使館和公開來源，也就是媒體，獲得其他國家的報告。", "confidence": "high", "notes": ""}

499. Did British government, US government, or an NGO in America, or a nonprofit in America, ever come to Britain and take some of the findings, or oversee, or analyze any findings from your country?
→ {"text": "英國政府、美國政府、美國的非政府組織或非營利組織，是否曾經來到英國取走一些調查結果，或監督、分析來自你們國家的任何發現？", "confidence": "high", "notes": ""}

500. I believe that some files were exchanged.
→ {"text": "我相信有些文件曾被交換。", "confidence": "high", "notes": ""}

501. Yes, ma'am.
→ {"text": "是的，女士。", "confidence": "high", "notes": ""}

502. And I think that some of the Blue Book personnel made the odd visit.
...
509. They do not say anything.
→ {"text": "他們什麼都不說。", "confidence": "high", "notes": ""}

510. The American government leaks a lot of material.
...
513. Yeah, I have a story.
→ {"text": "是的，我有一個故事。", "confidence": "high", "notes": ""}

514. My father worked for the Department of Transport.
→ {"text": "我父親在交通部工作。", "confidence": "high", "notes": ""}

515. No, hold the story.
→ {"text": "不，先保留這個故事。", "confidence": "high", "notes": ""}

516. Hold the story.
→ {"text": "先不要講這個故事。", "confidence": "high", "notes": ""}

517. I got one minute.
→ {"text": "我還剩一分鐘。", "confidence": "high", "notes": ""}

518. OK, it's a good story, though.
→ {"text": "好的，但這是個好故事。", "confidence": "high", "notes": ""}

519. I know.
→ {"text": "我知道。", "confidence": "high", "notes": ""}

520. We'll come back for it, second round, I promise.
→ {"text": "我們下一輪會回來聽，我保證。", "confidence": "high", "notes": ""}

521. I'll give it to you.
...
528. We, at the meeting, talked about the fact that we have to take actions and do more research in this area.
→ {"text": "我們在會議上談到必須採取行動並在這個領域進行更多研究。", "confidence": "high", "notes": ""}

529. And suggestions were made at that meeting to have a summit meeting.
→ {"text": "那次會議上有人建議舉行高峰會。", "confidence": "high", "notes": ""}

530. And I was asked to start preparing for this summit meeting.
→ {"text": "我被要求開始為這次高峰會做準備。", "confidence": "high", "notes": ""}

531. So for more than 10 years, I have been trying to make efforts and start this summit.
→ {"text": "所以十多年來，我一直在努力推動並啟動這次高峰會。", "confidence": "high", "notes": ""}

532. I have been preparing for this summit meeting on UFO.
→ {"text": "我一直在為這次關於 UFO 的高峰會做準備。", "confidence": "high", "notes": ""}

533. And this time, the Rockefeller Foundation hosted this meeting.
→ {"text": "這一次，洛克菲勒基金會主辦了這次會議。", "confidence": "high", "notes": ""}

534. They also invited me to Princeton University.
→ {"text": "他們還邀請我到普林斯頓大學。", "confidence": "high", "notes": ""}

535. One of the deans there met with me.
→ {"text": "那裡的一位院長與我會面。", "confidence": "high", "notes": ""}

536. And he promised me that he will try to organize a very high-level scientist group to do research.
→ {"text": "他向我承諾會試圖組織一個非常高層級的科學家團隊來進行研究。", "confidence": "high", "notes": ""}

537. And they will make an exception and take a Chinese person to join this group, to join this expert or this scientist group.
→ {"text": "他們會破例讓一位中國人加入這個團隊，加入這個專家或科學家團隊。", "confidence": "high", "notes": ""}

538. And once the scientific research results in China have been acknowledged by this group, it will be published.
→ {"text": "一旦中國的科學研究成果被這個團隊認可，就會被發表。", "confidence": "high", "notes": ""}

539. And it will be acknowledged around the world.
→ {"text": "而且會在全世界得到認可。", "confidence": "high", "notes": ""}

540. Nowadays, we have many results at hand.
→ {"text": "如今，我們手邊已經有很多研究成果。", "confidence": "high", "notes": ""}

541. We are trying to verify those results and exchange those information with other organizations.
→ {"text": "我們正在努力驗證這些結果並與其他組織交換資訊。", "confidence": "high", "notes": ""}

542. So in my opinion, our next step is to become more active.
→ {"text": "所以在我看來，我們的下一步是變得更加積極。", "confidence": "high", "notes": ""}

543. So like me, I am the chairman of the Chinese UFO Federation.
→ {"text": "就像我一樣，我是中國 UFO 聯合會的主席。", "confidence": "high", "notes": ""}

544. Our work is not only to find out where those UFOs are, we also have to focus on the next step that is the high technology that is from outer space.
→ {"text": "我們的工作不僅是找出那些 UFO 在哪裡，我們還必須關注下一步，那就是來自外太空的高科技。", "confidence": "high", "notes": ""}

545. Thank you very much.
→ {"text": "非常感謝。", "confidence": "high", "notes": ""}

546. Thanks to all the panelists.
→ {"text": "感謝所有小組成員。", "confidence": "high", "notes": ""}
...
553. Let's make sure-- let's talk about what-- Some examples. --with UFOs or-- Yes, yes. --ETs.
→ {"text": "讓我們確認——讓我們談談什麼——一些例子。——關於 UFO 或——是的，是的。——外星人。", "confidence": "medium", "notes": "原文較破碎，依語境翻譯"}

554. OK, thank you.
→ {"text": "好的，謝謝。", "confidence": "high", "notes": ""}

555. Exactly, I understand.
→ {"text": "正是如此，我明白。", "confidence": "high", "notes": ""}

556. For instance, just to make some examples, we could mention-- this could be linked to the previous question too.
...
561. They were round objects with dome.
...
564. What we may say is that there is a definite pattern.
→ {"text": "我們可以說的是，這有一個明確的模式。", "confidence": "high", "notes": ""}

565. In other words, in many cases, we see the same kind of event, a definite craft of a certain shape, a couple of occupants, and a lot of phenomena which may be related among them.
...
572. There are even official photographs of these cases in our country.
→ {"text": "在我們國家甚至有這些案例的官方照片。", "confidence": "high", "notes": ""}

573. Thank you so much.
→ {"text": "非常感謝。", "confidence": "high", "notes": ""}
...
577. How did the government respond?
→ {"text": "政府如何反應？", "confidence": "high", "notes": ""}

578. How did the press respond?
→ {"text": "媒體如何反應？", "confidence": "high", "notes": ""}

579. There was extensive media interest, Congresswoman, and huge public interest, too, as a result.
→ {"text": "議員女士，這引起了廣泛的媒體關注，也因此引起了巨大的公眾興趣。", "confidence": "high", "notes": ""}

580. On the website, for example, the National Archives website-- I don't have the statistics in front of me, but it was hundreds of thousands of hits, if not more.
→ {"text": "例如在網站上，國家檔案館的網站——我手邊沒有統計數據，但訪問量有數十萬次，甚至更多。", "confidence": "high", "notes": ""}

581. And were the responses positive, or did they make fun of it?
→ {"text": "那麼反應是正面的，還是他們在嘲笑這件事？", "confidence": "high", "notes": ""}

582. A bit of both, ma'am.
→ {"text": "兩者都有，女士。", "confidence": "high", "notes": ""}

583. I think some people were incredibly interested.
→ {"text": "我想有些人非常感興趣。", "confidence": "high", "notes": ""}

584. Some people were concerned that taxpayers' money had been spent on this at all.
→ {"text": "有些人擔心納稅人的錢竟然被花在這上面。", "confidence": "high", "notes": ""}

585. And some people thought that the whole thing was disinformation and all the good stuff was being kept back.
→ {"text": "還有些人認為整件事都是假情報，所有重要的東西都被隱瞞了。", "confidence": "high", "notes": ""}

586. OK, thank you very much.
→ {"text": "好的，非常感謝。", "confidence": "high", "notes": ""}

587. I yield my time.
→ {"text": "我讓出我的時間。", "confidence": "high", "notes": ""}
...
603. What was your conclusion?
→ {"text": "你的結論是什麼？", "confidence": "high", "notes": ""}

604. No.
→ {"text": "沒有。", "confidence": "high", "notes": ""}

605. My personal conclusion is that the case is absolutely true.
→ {"text": "我個人的結論是這個案例絕對是真實的。", "confidence": "high", "notes": ""}

606. Besides, I have also a personal-- What's true?
→ {"text": "此外，我還有一個個人的——什麼是真實的？", "confidence": "high", "notes": ""}

607. No, no.
→ {"text": "不，不。", "confidence": "high", "notes": ""}

608. That it was a balloon?
→ {"text": "是氣球嗎？", "confidence": "high", "notes": ""}

609. Is that what's true?
→ {"text": "那是真實的嗎？", "confidence": "high", "notes": ""}

610. No, no, absolutely.
→ {"text": "不，不，絕對不是。", "confidence": "high", "notes": ""}

611. That we were facing an extraterrestrial spaceship.
→ {"text": "我們面對的是一艘外星太空船。", "confidence": "high", "notes": ""}

612. OK.
→ {"text": "好的。", "confidence": "high", "notes": ""}

613. Besides, a very interesting thing is this.
...
620. You know, in the USA, we have the crashed objects, and even the corpses of the pilots.
...
624. Frankly, today, I do not know.
→ {"text": "坦白說，今天，我不知道。", "confidence": "high", "notes": ""}
...
628. Unacceptable to your government?
→ {"text": "對你的政府來說不可接受？", "confidence": "high", "notes": ""}

629. Unacceptable to your military?
→ {"text": "對你的軍方來說不可接受？", "confidence": "high", "notes": ""}

630. Which?
→ {"text": "哪一個？", "confidence": "high", "notes": ""}

631. Does your government consider cover-up unacceptable?
→ {"text": "你的政府認為真相掩蓋是不可接受的嗎？", "confidence": "high", "notes": ""}

632. Right.
→ {"text": "是的。", "confidence": "high", "notes": ""}

633. It's unacceptable.
→ {"text": "這是不可接受的。", "confidence": "high", "notes": ""}

634. But now, looking at what the Chinese government thinks, I don't think they're exactly there yet, because the Chinese government doesn't have as much information on ET as that held by the US government, such as the remains of these ETs and so on.
→ {"text": "但現在，看看中國政府的想法，我認為他們還不完全在那個階段，因為中國政府沒有像美國政府那樣多的關於外星人的資訊，比如這些外星人的遺體等等。", "confidence": "high", "notes": ""}

635. But I can also tell you this, on the issue of UFO or flying objects, the Chinese government is still very interested.
→ {"text": "但我也可以告訴你這一點，在 UFO 或飛行物體的問題上，中國政府仍然非常感興趣。", "confidence": "high", "notes": ""}

636. We have a commander for the Air Force.
→ {"text": "我們有空軍司令。", "confidence": "high", "notes": ""}

637. Before that person takes office, they would often come to me and talk to me before they take office.
→ {"text": "在那個人上任之前，他們經常會在上任前來找我談話。", "confidence": "high", "notes": ""}

638. And also, a lot of people in the Air Force come talk to us and say that, oh, UFO is a big issue.
→ {"text": "而且，空軍中的很多人也來找我們談話，說，哦，UFO 是個大問題。", "confidence": "high", "notes": ""}

639. We have to go talk to you.
→ {"text": "我們必須去找你談談。", "confidence": "high", "notes": ""}

640. We have to talk to the Chinese UFO Federation.
→ {"text": "我們必須與中國 UFO 聯合會談談。", "confidence": "high", "notes": ""}

641. So all in all, in China, the people in the government see this as a military issue, a security issue, which is not entirely the same as our approach.
→ {"text": "所以總的來說，在中國，政府裡的人把這視為軍事問題、安全問題，這與我們的做法不完全相同。", "confidence": "high", "notes": ""}

642. So the government is not trying to cover up anything.
→ {"text": "所以政府並沒有試圖掩蓋任何事情。", "confidence": "high", "notes": ""}

643. But they see this as still confidential, because they think this is a national security and a military issue.
→ {"text": "但他們認為這仍然是機密的，因為他們認為這是國家安全和軍事問題。", "confidence": "high", "notes": ""}

644. We have some examples here.
→ {"text": "我們這裡有一些例子。", "confidence": "high", "notes": ""}

645. We have been notified some sightings by the government.
→ {"text": "我們曾收到政府通知的一些目擊事件。", "confidence": "high", "notes": ""}

646. And they seek our suggestions and opinions sometimes.
→ {"text": "而且他們有時會徵求我們的建議和意見。", "confidence": "high", "notes": ""}

647. Thank you very much.
→ {"text": "非常感謝。", "confidence": "high", "notes": ""}

648. Thank you, thank you.
...
652. I have a good eyesight.
→ {"text": "我視力很好。", "confidence": "high", "notes": ""}

653. Someone might say of a girl that she has tons of lipstick on.
→ {"text": "有人可能會說一個女孩塗了成噸的口紅。", "confidence": "high", "notes": ""}

654. Now, there's tons of material that the United States is supposed to have.
→ {"text": "現在，據說美國有成噸的材料。", "confidence": "high", "notes": ""}

655. Is that figurative or literal?
→ {"text": "那是比喻性的還是字面意義上的？", "confidence": "high", "notes": ""}

656. I think both.
→ {"text": "我認為兩者都有。", "confidence": "high", "notes": ""}
...
660. Did he mean like tons of lipstick or literal tons of stuff?
→ {"text": "他的意思是像成噸的口紅那樣比喻性的，還是字面意義上成噸的東西？", "confidence": "high", "notes": ""}

661. His son tells numerous stories about seeing boxes, cars coming, military cars delivering material.
...
664. Another round, thanks.
→ {"text": "再一輪，謝謝。", "confidence": "high", "notes": ""}

665. Thank you.
→ {"text": "謝謝。", "confidence": "high", "notes": ""}

666. Let me ask each of you to be very brief.
→ {"text": "讓我請你們每個人非常簡短地回答。", "confidence": "high", "notes": ""}

667. But I want to know how many of the sightings of what you know about vehicles, saucers, whatever you want to call them, how many of those are unmanned versus manned?
→ {"text": "但我想知道你們所知道的關於載具、飛碟，無論你們怎麼稱呼它們，有多少是無人駕駛的，有多少是有人駕駛的？", "confidence": "high", "notes": ""}

668. Do you know?
→ {"text": "你們知道嗎？", "confidence": "high", "notes": ""}

669. I mean, is there sort of a ratio or most of these without somebody so-called driving it?
...
675. Or maybe the object landed and the occupant came out.
→ {"text": "或者可能物體著陸了，然後乘員出來了。", "confidence": "high", "notes": ""}

676. But in other cases when the object is at a distance, which is the majority of UFO sightings, we would have no way of knowing if it's automatically piloted or not.
→ {"text": "但在其他情況下，當物體在遠處時，這是大多數 UFO 目擊事件的情況，我們無法知道它是否是自動駕駛的。", "confidence": "high", "notes": ""}

677. Then we have cases where we have large objects, which obviously must be manned by someone.
→ {"text": "然後我們有一些案例是有大型物體，這顯然必須由某人駕駛。", "confidence": "high", "notes": ""}

678. And then out of the large object, small little probes come.
...
684. But certainly there is a percentage that do have occupants.
→ {"text": "但肯定有一定比例是有乘員的。", "confidence": "high", "notes": ""}

685. But the exact statistics, because of the distances, there's no way of knowing.
...
690. You can't tell anything from stuff flying around in the sky.
→ {"text": "你無法從天上飛來飛去的東西判斷出任何事情。", "confidence": "high", "notes": ""}

691. It's not until you interact with whoever is flying them or get inside the ship that you can learn anything.
→ {"text": "除非你與駕駛它們的人互動或進入飛船內部，否則你無法學到任何東西。", "confidence": "high", "notes": ""}

692. You really can't determine very much from watching whether it's their stuff, their stuff.
→ {"text": "你真的無法從觀察中確定太多東西，無論是它們的東西，它們的東西。", "confidence": "high", "notes": ""}

693. It's just stuff flying around in the sky.
→ {"text": "那只是天上飛來飛去的東西。", "confidence": "high", "notes": ""}

694. It just shows you that something very mysterious is going on.
→ {"text": "它只是向你表明正在發生一些非常神秘的事情。", "confidence": "high", "notes": ""}
...
698. He reported that he has seen that dozens of UFOs that have lined up and are flying in the same direction.
→ {"text": "他報告說他看到幾十個 UFO 排成一列，朝同一個方向飛行。", "confidence": "high", "notes": ""}

699. And he said that there must be a highly intelligent organism in there to fly in that.
→ {"text": "而且他說裡面一定有一個高度智慧的生物在駕駛。", "confidence": "high", "notes": ""}

700. So I think this is a very valuable report, because it reported by the high level military officials.
...
703. And so in this high level military officers, he often joined and participated in our seminars as well.
→ {"text": "所以這位高階軍官也經常參加我們的研討會。", "confidence": "high", "notes": ""}

704. And he even gave me a picture of the UFO.
→ {"text": "而且他甚至給了我一張 UFO 的照片。", "confidence": "high", "notes": ""}

705. This is something very special.
→ {"text": "這是非常特別的東西。", "confidence": "high", "notes": ""}

706. That was a picture that's taken from the satellite.
→ {"text": "那是一張從衛星拍攝的照片。", "confidence": "high", "notes": ""}

707. And that was very clear, crisp, clear picture of a UFO.
→ {"text": "那是一張非常清晰、銳利的 UFO 照片。", "confidence": "high", "notes": ""}

708. Thank you.
→ {"text": "謝謝。", "confidence": "high", "notes": ""}

709. In my personal opinion, I consider that there is a big difference between the official cases and the civilian cases.
...
715. And then probably there are also remotely piloted probes.
→ {"text": "然後可能還有遙控探測器。", "confidence": "high", "notes": ""}

716. And they are probably objects no more than half a meter in diameter of dimension, this is.
→ {"text": "而且它們可能是直徑不超過半公尺的物體，就是這樣。", "confidence": "high", "notes": ""}

717. But they are probably able to fly and to give information to this strange phenomena.
→ {"text": "但它們可能能夠飛行並為這個奇怪的現象提供資訊。", "confidence": "high", "notes": ""}

718. All right.
→ {"text": "好的。", "confidence": "high", "notes": ""}

719. Thank you very much for your time and your testimony.
→ {"text": "非常感謝你們的時間和證詞。", "confidence": "high", "notes": ""}

720. It was a terrific panel.
→ {"text": "這是一個非常出色的小組。", "confidence": "high", "notes": ""}

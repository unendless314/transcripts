...
117. Dr. Greer.
→ {"text": "格里爾博士。", "confidence": "high", "notes": ""}


## Speaker Group 18

118. Well on that note, it reminds me of a conversation I had with some people at the CIA and there's a term that's used there and you'll forgive my vernacular where much of this subject is referred to as WSFM, sounds like a radio station, it means weird science and fricking magic and that is the term that's used at the CIA and other places to describe some of this and I think that what we have to understand is that if you're dealing with and I do want to go into this because this is part of the summary and brief I provided for in the Obama briefing and elsewhere, if you're dealing with civilizations that are 10 to the 6th to 10 to the 7th years, hundreds of thousands to millions of years, technologically more developed than we are, every manifestation of their technology would look like magic to us.
→ {"text": "嗯，關於這一點，這讓我想起我與 CIA 一些人的對話，那裡有一個專門術語，請原諒我的俗語，這個主題的大部分內容被稱為 WSFM，聽起來像個廣播電台，它的意思是詭異科學與魔法，這是 CIA 和其他地方用來描述這類現象的術語，我認為我們必須理解的是，如果你正在處理——而我確實想深入探討這一點，因為這是我在歐巴馬簡報和其他場合提供的摘要和簡報的一部分——如果你正在處理技術比我們先進 10 的 6 次方到 10 的 7 次方年、也就是數十萬到數百萬年的文明，他們的技術的每一個表現在我們看來都像魔法。", "confidence": "high", "notes": ""}

119. For example, if you were to go back to the time of Thomas Jefferson and show them an iPhone or worse to say in Massachusetts, you'd be burned at the stake as a witch because everything would be absolutely look like magic.
→ {"text": "例如，如果你回到湯瑪斯·傑佛遜的時代，向他們展示一部 iPhone，或者更糟的是在麻薩諸塞州，你會被當作女巫綁在火刑柱上燒死，因為所有事情看起來絕對就像魔法。", "confidence": "high", "notes": ""}

120. So I think that we have to have a certain amount of humility in realizing that we're dealing with a universe that is vast and infinite, that in our own galaxy alone, which has 100 billion star systems, the same number of stars as we have neurons in our brain interestingly, that we're dealing with civilizations just in our own galaxy which is one of billions that are able to go through interstellar space.
...
125. However, when you start getting into the new physics that have been done where you have the ability to teleport across vast distances instantly and this has been done with particles but we're talking about civilizations that can do it with entire spacecraft and occupants, you're dealing with an entirely new physics but their communication devices and their own innate abilities allow for thought actuated events and I know Dr. Wood may mention this and that he discovered when he was doing some work for Old Mac McDonald and McDonald Douglas that he looked into some cases where in some meetings with these ETs involved a little box and there was a direct thought communication but it was also being facilitated through electronics and this is something that we call technology assisted consciousness and thought and this is a very specific area
...
128. One thing I also want to point out is that if we're being visited by advanced civilizations and it's our assessment that certainly we are, who is handling that relationship?
→ {"text": "我還想指出的一件事是，如果我們正被先進文明造訪——而我們的評估確實是如此——誰在處理這種關係？", "confidence": "high", "notes": ""}

129. Do we cede that management to the military industrial complex and what are the consequences of doing so?
→ {"text": "我們是否將這種管理權讓給軍事工業複合體，這樣做的後果是什麼？", "confidence": "high", "notes": ""}

130. Think about this very carefully.
...
133. You're the head of the world."
→ {"text": "您是世界的領袖。」", "confidence": "high", "notes": ""}

134. She says, "No, we can't.
→ {"text": "她說：「不，我們不能。", "confidence": "high", "notes": ""}

135. It's too dangerous for Boutrous."
...
138. And what I-- most people don't know that, but what I found when I was talking to Senator Pell who was chairman of the Foreign Relations Committee and I was at a meeting with Edgar Mitchell and some other folks and I looked at him and he said, "Dr. Grier, I have never been given any information on this even though I have inquired through any official channels."
→ {"text": "而我——大多數人不知道這一點，但我發現當我與佩爾參議員交談時，他是外交委員會主席，我當時與埃德加·米切爾和其他一些人在一個會議上，我看著他，他說：「格里爾博士，我從未得到任何關於這方面的資訊，儘管我透過任何官方管道詢問過。」", "confidence": "high", "notes": ""}

139. And I said, "Yes, sir.
...
142. I said, "Well, I am."
→ {"text": "我說：「嗯，我確實是對的。」", "confidence": "high", "notes": ""}

143. And I said, "Well, what a shame."
→ {"text": "我說：「嗯，真是遺憾。」", "confidence": "high", "notes": ""}

144. So I think this is another dimension.
→ {"text": "所以我認為這是另一個面向。", "confidence": "high", "notes": ""}

145. There's a science and technology part of it, but there's the part of it about relationships and we are not alone in the universe and we need to have a situation on this planet where our higher nature, our better angels, folks like Senator Pell and others who would approach this in an enlightened way could reach out and form what has begun to be discussed in the French government that I referred to earlier in this Ministry of Defense memo to me, a peaceful, interplanetary, interstellar diplomatic initiative.
→ {"text": "這有科學和技術的部分，但還有關於關係的部分：我們在宇宙中並不孤單，我們需要在這個星球上創造一種情況，讓我們的高尚本性、我們更好的天使、像佩爾參議員這樣以及其他會以開明方式處理這個問題的人能夠伸出手，促成我在前面提到的法國國防部給我的備忘錄中、法國政府已開始討論的那件事——一個和平的、跨行星的、跨星際的外交倡議。", "confidence": "high", "notes": ""}

146. And to be honest with you, that's how I first got involved with this, was to establish such an effort, which we are doing as a citizen's diplomatic effort.
→ {"text": "坦白說，這就是我最初參與這件事的方式，就是為了建立這樣一個努力，我們正在以公民外交努力的形式進行。", "confidence": "high", "notes": ""}

147. But in the meanwhile, I got diverted into this morass of the national security state because I felt that our leaders need to know and more importantly, the public need to know.
→ {"text": "但與此同時，我被轉移到國家安全體制的這個泥沼中，因為我覺得我們的領導人需要知道，更重要的是，公眾需要知道。", "confidence": "high", "notes": ""}

148. And we need to then figure out how we're going to advance.
→ {"text": "我們需要弄清楚我們將如何前進。", "confidence": "high", "notes": ""}

149. And in the summary I did for the president, there are a number of action points.
→ {"text": "在我為總統做的摘要中，有許多行動要點。", "confidence": "high", "notes": ""}

150. And one of them is to appoint internationally a high level committee of folks who could go out and make a peaceful contact that is not militarized, that is not covert, that is not being run by the national security state, but is being done on behalf of all of us, the children of earth.
→ {"text": "其中之一是在國際上任命一個高層委員會，由能夠出去進行和平接觸的人組成，這種接觸不是軍事化的、不是秘密的、不是由國家安全體制運作的，而是代表我們所有人、地球之子進行的。", "confidence": "high", "notes": ""}

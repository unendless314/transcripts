...
91. We ought to tell all the people have a right to know everything."
→ {"text": "我們應該告訴所有人，他們有權知道一切。」", "confidence": "high", "notes": ""}

92. And I found myself in this peculiar situation of starting to ask questions about what might be in there that we had to try to be careful about revealing.
→ {"text": "然而我發現自己處於這種特殊境地，開始質問其中可能包含什麼內容，是我們在揭露時必須謹慎的。", "confidence": "high", "notes": ""}

93. Now in that particular case, it wasn't a hard question because we found things about the assassination program of the Central Intelligence Agency, the Phoenix program.
→ {"text": "在那個案件中，答案並不難找，因為我們發現了中央情報局（Central Intelligence Agency）的暗殺計畫，即鳳凰計畫（Phoenix program）。", "confidence": "high", "notes": ""}

94. We found out that they were smuggling opium in Southeast Asia to help fund it.
...
97. And it had occurred because the Central Intelligence Agency, when it was created in 1947, was out of Section 5412, the 5412 committee was set up inside the National Security Council to actually oversee covert operations.
→ {"text": "這些事情之所以發生，是因為中央情報局（Central Intelligence Agency）於 1947 年成立時，根據第 5412 條款，在國家安全會議（National Security Council）內部設立了 5412 委員會，實際上負責監督秘密行動。", "confidence": "high", "notes": ""}

98. For the first time, it actually legitimized the undertaking of covert operations that were not going to be revealed to the Congress.
→ {"text": "這首次使進行不向國會揭露的秘密行動變得合法化。", "confidence": "high", "notes": ""}

99. It was before we had an intelligence committee.
→ {"text": "這是在我們成立情報委員會之前。", "confidence": "high", "notes": ""}

100. You remember that Prescott Bush, the United States Senator from Connecticut, was the one who would brief in certain Congress people and certain senators about this.
→ {"text": "各位記得，康乃狄克州參議員普雷斯科特·布希（Prescott Bush）是向特定國會議員與參議員簡報此事的人。", "confidence": "high", "notes": ""}

101. So there was this entire kind of extra constitutional process or protocols that began to be undertaken right at the very beginning.
→ {"text": "因此，從一開始就存在著這整套超憲法程序或協議。", "confidence": "high", "notes": ""}

102. Finally, they set up the 5412 committee inside the National Security Council that oversaw those things.
→ {"text": "最終，他們在國家安全會議內部設立了 5412 委員會來監督這些事務。", "confidence": "high", "notes": ""}

103. And as I said, I had never had access to that until we saw the Pentagon Papers, and on reviewing it with Neil Sheehan and the others, I came to the conclusion that all of this should be revealed, that these were criminal activities that had happened that were all happening outside of the United States, but they were having such dramatic effects inside the United States that I thought they ought to be talked about.
→ {"text": "如我所說，直到我們看到五角大樓文件之前，我從未接觸過這些資訊。在與尼爾·希恩（Neil Sheehan）及其他人審閱後，我得出結論：所有這些都應該被揭露，這些都是發生在美國境外的犯罪活動，但對美國境內產生了如此巨大的影響，我認為應該被討論。", "confidence": "high", "notes": ""}

104. But that was my first experience with this.
→ {"text": "但那是我第一次接觸這類事情。", "confidence": "high", "notes": ""}

105. As it proceeded, I ended up becoming chief counsel in the Karen Silkwood case, the woman that was killed out in Oklahoma at the nuclear site out there.
→ {"text": "隨著事件發展，我最終成為凱倫·絲克伍案（Karen Silkwood case）的首席律師，她是在奧克拉荷馬州核設施遇害的女性。", "confidence": "high", "notes": ""}

106. And during our investigations of that, we discovered that 98 pounds of bomb-grade plutonium were being smuggled out of the Kerr-McGee nuclear facility, the reprocessing plant, and we discovered that it was actually being transported secretly to Israel.
→ {"text": "在調查過程中，我們發現 98 磅武器級鈽（bomb-grade plutonium）正從 Kerr-McGee 核設施的再處理廠被走私出去，我們發現這些材料實際上被秘密運往以色列。", "confidence": "high", "notes": ""}

107. So I touched on that old third rail.
...
112. Now because of my discovery of that, it was a clear absolute blatant violation of the Nuclear Nonproliferation Treaty, and so I briefed the judge.
→ {"text": "由於我發現了這件事，這明顯是對《核武禁擴條約》（Nuclear Nonproliferation Treaty）的公然且絕對的違反，因此我向法官簡報。", "confidence": "high", "notes": ""}

113. We had the Judge Theis, Frank G. Theis, was the chief counsel -- was the judge on that case.
→ {"text": "該案的法官是法蘭克·G·泰斯法官（Judge Frank G. Theis）。", "confidence": "high", "notes": ""}

114. I provided a memorandum to him, an affidavit to him explaining the whole thing, and the following Monday he contacted me and said the Central Intelligence Agency had contacted him and wanted to have an in-camera ex parte meeting with him, and he met with them and immediately dismissed one of the counts in our case, in the Karen Silkwood case, the whole -- her death on the highway.
...
121. We uncovered all the smuggling of the weapons that were going on, the cocaine smuggling operations that were going on.
→ {"text": "我們揭露了所有正在進行的武器走私、古柯鹼走私行動。", "confidence": "high", "notes": ""}

122. It became clear to me that everybody knew about this, that all kinds of people knew about this going on, but the citizens didn't.
...
127. I kept trying to have contact with people inside the intelligence community to say look, if there's something that you think I ought to know that would convince me that the American people somehow shouldn't know about this, tell me about it, will you?
...
130. Well that's not an answer, just to stay away from it.
...
134. Nothing comes close to matching this issue.
→ {"text": "沒有任何事情能接近這個議題的重要性。", "confidence": "high", "notes": ""}

135. Because the reality of it is, is that because whatever this extraterrestrial intelligence is, they obviously share the belief that somehow we shouldn't be just told right straight outright.
→ {"text": "因為事實是，無論這個外星智慧（extraterrestrial intelligence）是什麼，他們顯然也認為我們不應該被直接明確地告知。", "confidence": "high", "notes": ""}

136. As people have said, why don't they land on the White House lawn and just tell us?
→ {"text": "正如人們所說，為什麼他們不降落在白宮草坪上直接告訴我們？", "confidence": "high", "notes": ""}

137. So there is obviously some type of consensus that exists at the highest levels of the security, cosmic, top-secret clearance in our government.
→ {"text": "因此顯然在我們政府的最高安全層級——宇宙最高機密許可（cosmic top-secret clearance）——存在著某種共識。", "confidence": "high", "notes": ""}

138. And when I asked Gorbachev about this, because I was legal counsel to the State of the World Forum for Gorbachev and Senator Baker at the end of the Cold War, he told me flat out that these things existed and that they'd known that these existed and they were in communication with the United States government about this.
→ {"text": "當我向戈巴契夫（Gorbachev）詢問此事時——因為我在冷戰結束時擔任戈巴契夫與參議員貝克（Senator Baker）的「世界論壇」（State of the World Forum）法律顧問——他直截了當地告訴我，這些事情存在，他們知道這些存在，並且他們正在就此與美國政府溝通。", "confidence": "high", "notes": ""}

139. So what I'm saying is that we need to as citizens be insistent upon finding out about this unless and until somebody communicates information to us that makes sense as to why it is that people all shouldn't know about this.
→ {"text": "所以我要說的是，作為公民，我們需要堅持查明此事，除非且直到有人向我們傳達有意義的資訊，解釋為什麼所有人不應該知道這些。", "confidence": "high", "notes": ""}

140. And they haven't told me that yet, and so until they do, I'm going to continue to try to find out everything I can about it and share it with people who've had the kind of responsible positions that you have had in your lives and still have in your lives.
→ {"text": "他們還沒有告訴我，所以在他們告訴我之前，我將繼續盡力查明一切，並與那些像你們一樣曾經擔任或仍在擔任負責任職位的人分享。", "confidence": "high", "notes": ""}

141. Because the reality is you still have political capital, whether you're 87 years old or 39 years old or whatever your ages are now, that you still have political capital that can effectuate a change and that for you to go collectively to sit down with certain members of Congress or certain people together to say, "Look, this is what we know and we want to act responsibly.
→ {"text": "因為事實是，無論你們現在是 87 歲、39 歲還是其他年齡，你們仍然擁有政治資本，能夠促成改變。你們可以集體與特定國會議員或特定人士坐下來說：「聽著，這是我們所知道的，我們想要負責任地行動。", "confidence": "high", "notes": ""}

142. Can you please help us act responsibly, but we're going to act in any event?"
→ {"text": "你們能幫助我們負責任地行動嗎？但無論如何我們都會行動。」", "confidence": "high", "notes": ""}

143. And that's how you will find out, I believe.

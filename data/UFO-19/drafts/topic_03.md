...
86. Could we now have Dr. Greer take 10 minutes?
→ {"text": "現在是否可以請格里爾博士（Dr. Greer）進行十分鐘的發言？", "confidence": "high", "notes": ""}

87. Thank you very much.
→ {"text": "非常感謝。", "confidence": "high", "notes": ""}

88. I appreciate being here again.
...
91. This has resulted in a number of errors in the equations, which have been corrected by people who have looked at them very carefully.
...
94. This began to be explored by people like Nikola Tesla and others.
...
97. The FBI refused.
→ {"text": "聯邦調查局（FBI）拒絕了。", "confidence": "high", "notes": ""}

98. At any rate, science continues because the laws of the universe are, in fact, universal, and they can be discovered here or around Alpha Centauri or anyplace else in the cosmos.
...
104. Yes, it's a famous rock group.
→ {"text": "是的，這是一個著名的搖滾樂團。", "confidence": "high", "notes": ""}

105. However, the Foo Fighters took their name from the reports of these objects seen in the theater of World War II that were flying around our aircraft.
→ {"text": "然而，幽浮光球（Foo Fighters）這個名字取自二戰戰區報告中看到的這些物體，它們在我們的飛機周圍飛行。", "confidence": "high", "notes": ""}

106. We thought it was a secret weapon of the Nazis.
→ {"text": "我們以為這是納粹的秘密武器。", "confidence": "high", "notes": ""}

107. The Nazis thought it was a secret weapon of ours.
→ {"text": "納粹以為這是我們的秘密武器。", "confidence": "high", "notes": ""}

108. There is Jimmy Doolittle, the famous general.
→ {"text": "這位是吉米·杜立德（Jimmy Doolittle），著名的將軍。", "confidence": "high", "notes": ""}

109. His nephew is a dear friend of mine, and he has testified that General Doolittle was sent by FDR over to the European Theater in World War II, investigated the Foo Fighters and came back and told Roosevelt, and I quote, "They are interplanetary vehicles."
...
116. All of this went deep black because they figured out, at that point, gravity control.
...
119. Eventually, these breakthroughs in human discovery were complemented by the study of the extraterrestrial material that were retrieved from these events.
→ {"text": "最終，人類發現上的這些突破，因對這些事件中回收的外星物質的研究而得到補充。", "confidence": "high", "notes": ""}

120. And contrary to most people's thoughts, the Roswell event was actually a downing of an extraterrestrial vehicle by an electromagnetic system that was hidden in a radar dome that was switched on.
→ {"text": "與大多數人的想法相反，羅斯威爾事件（Roswell event）實際上是一艘外星載具被擊落，當時一個隱藏在雷達罩內的電磁系統被啟動了。", "confidence": "high", "notes": ""}

121. And this is in an FBI document that I can provide for the committee and is on the flash drive given to the Congress.
→ {"text": "這是一份聯邦調查局（FBI）的文件，我可以提供給委員會，也在提供給國會的隨身碟中。", "confidence": "high", "notes": ""}

122. The result, ultimately, was that there were trans-dimensional physics that began to be studied that deal with the nexus between electromagnetism, energy generation, anti-gravity, and consciousness.
→ {"text": "最終的結果是，人們開始研究跨維度物理學（trans-dimensional physics），探討電磁學、能量生成、反重力和意識之間的關聯。", "confidence": "high", "notes": ""}

123. And we have discovered that there is a nexus and that, in fact, there are electromagnetic systems that have been developed that can interface directly with what we call coherent thought, the same way that you can interface with a system with lasers, which is coherent light, where you sync up all the wavelengths.
→ {"text": "我們發現這些領域之間存在著關聯，事實上，已經開發出了能夠直接與我們所謂的相干思維（coherent thought）進行介接的電磁系統，就像你可以用雷射（相干光）與系統進行介接一樣，同步所有的波長。", "confidence": "medium", "notes": "coherent thought 為專業術語，保留英文並加註"}

124. Ultimately, these breakthroughs were paralleled with amazing developments in the biological sciences and the experimentation with cloning.
→ {"text": "最終，這些突破與生物科學的驚人發展以及複製技術的實驗並行發展。", "confidence": "high", "notes": ""}

125. And this began many years earlier than was reported from Dolly the sheep in Scotland.
→ {"text": "而這比蘇格蘭多利羊（Dolly the sheep）被報導的時間早了許多年。", "confidence": "high", "notes": ""}

126. This goes a little beyond, I think, what this committee wants to look into.
→ {"text": "我認為這已經超出了這個委員會想要調查的範圍。", "confidence": "high", "notes": ""}

127. However, you need to understand that the technologies that we have, and we were discussing, are not theoretical.
→ {"text": "然而，你們需要理解，我們所擁有並且正在討論的這些技術並非理論性的。", "confidence": "high", "notes": ""}

128. We have actionable intelligence that any committee in Congress or executive action can find regarding current operations, and I just want to go through a list of them very quickly, of these facilities and corporations for which we have witnesses who can be subpoenaed by the committees of the Congress.
→ {"text": "我們掌握可執行的情報，國會任何委員會或行政行動都能發現與當前行動有關的資訊。我只想快速瀏覽一下這些設施和公司的清單，我們有證人可以被國會委員會傳喚。", "confidence": "high", "notes": ""}

129. This was developed at the request of Congressman Christopher Cox of Orange County, with whom I met, and was later further developed for the briefing that we put together for President Obama.
→ {"text": "這是在我與橙縣眾議員克里斯托弗·考克斯（Christopher Cox）會面時，應他的要求而編制的，後來我們為歐巴馬總統（President Obama）準備的簡報又進一步完善。", "confidence": "high", "notes": ""}

130. These facilities are the Edwards Air Force Base and subsections, where I'm at the Dry Lake Bed where the Lockheed Skunk Works operations, Haystack Butte, China Lakes, George Air Force Base, and the closed Norton Air Force Base, where an anti-gravity device, so-called alien reproduction vehicle, for which we have the schematics, was seen by Frank Carlucci and others on our witness team.
...
136. There are no roads into this facility.
→ {"text": "沒有道路通往這個設施。", "confidence": "high", "notes": ""}

137. The New Mexico facilities include Los Alamos National Labs with underground connectors to the so-called Dulce area where the biological work is being done, and Kirtland Air Force Base.
→ {"text": "新墨西哥州的設施包括洛斯阿拉莫斯國家實驗室（Los Alamos National Labs），有地下通道連接到所謂的杜爾塞（Dulce）地區，那裡正在進行生物學工作，還有柯特蘭空軍基地（Kirtland Air Force Base）。", "confidence": "high", "notes": ""}

138. And the complex there includes Sandia National Laboratories, Phillips Labs, Manzano Mountain Weapons Storage Facility, Coyote Canyon, and the White Sands Complex.
...
143. Also the Redstone Arsenal and the Marshall Space Flight Center.
...
146. This is just part of the information we have, and this information is on the flash drive given that you are all welcome to review.
→ {"text": "這只是我們所掌握資訊的一部分，這些資訊都在隨身碟中，歡迎各位查閱。", "confidence": "high", "notes": ""}
...
149. Well done and well timed because that sign came up just about three seconds after you landed.
→ {"text": "做得好，時間也掌握得很好，因為那個牌子在你結束後大約三秒才亮起。", "confidence": "high", "notes": ""}

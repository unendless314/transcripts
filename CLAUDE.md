...
- `data/<episode>/` - Working YAML/Markdown files (main.yaml, topics.json, terminology.yaml, translation_guidelines.md, proofread_guidelines.md)
...
**`data/<episode>/translation_guidelines.md`** - Translation style guide:
...
**`data/<episode>/proofread_guidelines.md`** - Proofreading guide (per-episode copy of `configs/proofread_guidelines_template.md`):
- Terminology/proper-noun rules, Whisper error handling, formatting rules
- Episode-specific section for known terms, legacy issues, verified facts
...
#   - configs/translation_guidelines_template.md (translation style guide)
...
- `configs/translation_guidelines_template.md` - Translation style guide template ✅
- `configs/proofread_guidelines_template.md` - Proofreading guide template (copy to `data/<episode>/proofread_guidelines.md` before proofreading) ✅
